...
@Service
public class RealTimeDataService implements ApplicationListener<BrokerAvailabilityEvent> {

	private static Log logger = LogFactory.getLog(RealTimeDataService.class);
	...
	@Autowired
	public RealTimeDataService(MessageSendingOperations<String> messagingTemplate) {
