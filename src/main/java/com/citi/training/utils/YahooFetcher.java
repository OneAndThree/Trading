...
public class YahooFetcher {
	...
	private final Map<String, String> tags = new HashMap<String, String>() { {
		...
		put("Last TradeOrderDetail Date", "d1");
		put("TradeOrderDetail Date", "d2");
		...
		put("Last TradeOrderDetail Real Time With Time", "k1");
		put("Change Percent Real Time", "k2");
		put("Last TradeOrderDetail Size", "k3");
		put("Change From 52-Week High", "k4");
		put("Percent Change From 52-Week High", "k5");
		put("Last TradeOrderDetail With Time", "l");
		put("Last TradeOrderDetail Price Only", "l1");
		put("High Limit", "l2");
		put("Low Limit", "l3");
		put("Days Range", "m");
		...
		put("Shares Owned", "s1");
		put("Short Ratio", "s7");
		put("Last TradeOrderDetail Time", "t1");
		put("TradeOrderDetail Links", "t6");
		put("Ticker Trend", "t7");
